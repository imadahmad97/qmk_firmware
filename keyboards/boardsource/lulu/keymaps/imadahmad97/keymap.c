...
[_LOWER] = LAYOUT(
  ...
  KC_VOLD, KC_VOLU, KC_BRID, KC_BRIU, CG_TOGG, CG_NORM, _______, _______, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE,
...
[_RAISE] = LAYOUT(
  RM_NEXT, RM_PREV, RM_SATU, RM_SATD, RM_VALU, RM_VALD,                     QK_RGB_MATRIX_HUE_UP, QK_RGB_MATRIX_HUE_DOWN, _______, _______, _______, _______,
...
#ifdef OLED_ENABLE
// Function to render the current layer name
